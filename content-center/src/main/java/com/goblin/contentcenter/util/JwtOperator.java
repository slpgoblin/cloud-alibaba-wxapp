package com.goblin.contentcenter.util;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODU5NzQxNTMsImV4cCI6MTU4NzE4Mzc1M30.k74bxXJChtSAoWsXxQ6YFuc3KD4B6EXUXe4FvMN63s0";
